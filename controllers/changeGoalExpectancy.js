...
async function changeGoalExpectancy(req,res,next){
    ...
    console.log(req.body.fixtureId)
...
*/
        ...
        const filter={"fixtureId":req.body.fixtureId}
       // console.log(myOdds)
       // const market=Object.values(myOdds[0].odds.correctScore)[i].market;
       // const myOdd=Object.values(myOdds[0].odds.correctScore)[i].odd;

        
        //const update = {"$set": { "score00":myData.session} }
        //db.collection.updateMany(filter, update, options)


        FixtureOdds.find({fixtureId:req.body.fixtureId},async (err,data)=>{
